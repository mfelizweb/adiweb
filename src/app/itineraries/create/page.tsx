// Converted CreateItineraryScreen.tsx from mobile to web
'use client'
...
const lang: Lang = langParam === 'en' || langParam === 'es' ? langParam : 'es'
  ...
  async function handleSave() {
    ...
    const finalEnd = endDate || dayjs(finalStart).add(15, 'day').toISOString()
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-6">
      ...
      {/* Aquí puedes renderizar los pasos como bloques con Tailwind. */}
    </div>
  )
}